...
const RequestSchema = new Schema({
    ...
    course_id: { type: Schema.Types.ObjectId, ref: "courses", required: true }, // Refers to the requested course
    affiliate_id: { type: Schema.Types.ObjectId, ref: "customers", required: false }, // Refers to the affiliate (optional)
});
